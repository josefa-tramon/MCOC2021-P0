...
casos = [1,2,3,4,5]
casos_nom = ["eigh",
			"eigh, driver='ev' y overwrite_a=False y overwrite_b=True ",
			"eigh, driver='evd' y overwrite_a=False y overwrite_b=True",
			"eigh, driver='evr' y overwrite_a=False y overwrite_b=True",
			"eigh, driver='evx' y overwrite_a=False y overwrite_b=True"]
...
for d in d_type:
	...
	for c in casos:
		...
		plt.title(f"Rendimiento eigh {c} {d}")
	...
	for C in casos:
		...
		plt.title(f"Rendimientos Eigh {d}")

		plt.legend([f"APhi_LambdaPhi_{casos_nom[0]}", f"APhi_LambdaPhi_{casos_nom[1]}", f"APhi_LambdaPhi_{casos_nom[2]}", f"APhi_LambdaPhi_{casos_nom[3]}", f"APhi_LambdaPhi_{casos_nom[4]}"])
