...
Ns = [20,30,50,100,110,120,140,160,180,200,500,800,1000,1100,1200,1300,1500,2000,3000,4000]
...
for c in c_type:
	...
	for i in range(10):
		...
		if type_str == "float64":
			fid = open(f"timing_inv_caso_3_longdouble_{i}.txt" , "w")

		elif type_str == "float32":
			fid = open(f"timing_inv_caso_3_double_{i}.txt" , "w")

		elif type_str == "float16":
			fid = open(f"timing_inv_caso_3_single_{i}.txt" , "w")

		else:
			fid = open(f"timing_inv_caso_3_half_{i}.txt" , "w")
